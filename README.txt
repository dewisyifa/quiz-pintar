...
- **AI Tools (ChatGPT & IBM Prompt Lab)**: Membantu dalam menyusun soal, membangun kerangka HTML/CSS/JS, serta memberikan saran desain dan struktur program.
...
1. Clone repositori ini:
   ```bash
   git clone https://github.com/username/quiz-pintar.git
